Log("Loading modified HealSprayMixin.lua for NS2 Balance Beta mod.")

-- Changes:
-- Heal spray adds maturity.
-- Heal spray speeds up evolution.
-- Exposed kHealScoreAdded and kAmountHealedForPoints by changing them from locals to fields.
