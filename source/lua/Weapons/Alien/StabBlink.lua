Log("Loading modified StabBlink.lua for NS2 Balance Beta mod.")
...
function StabBlink:GetAttackSpeedMultiplier()
    return kAttackAnimationLength / StabBlink.kAttackDuration
end
