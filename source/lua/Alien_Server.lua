Log("Loading modified Alien_Server.lua for NS2 Balance Beta mod.")

-- Changes:
-- Health regeneration now will work even when in combat.
-- Health regeneration uses eHP values now, instead of counting 1 point of healing as potentially 1
-- point of armor.
