...
MenuData.Config.OptionsMenu.General = MenuData.CreateDefaultOptionsLayout
{
    checksChildren =
    {
        ...
        {
            name = "inGameItemPurchasing",
            class = OP_TT_Checkbox,
            params =
            {
                optionPath = "inGameItemPurchasing",
                optionType = "bool",
                default = true,
                tooltip = Locale.ResolveString("OPTION_ITEM_PURCHASING_TOOLTIP"),
            },
            
            properties =
            {
                {"Label", Locale.ResolveString("OPTION_ITEM_PURCHASING")},
            },
        },
        --]]
    },
