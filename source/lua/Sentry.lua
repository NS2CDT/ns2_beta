Log("Loading modified Sentry.lua for NS2 Balance Beta mod.")
...
function Sentry:OnCreate()
    ...
    elseif Client then
        ...
        local function PlayScanPing(sentry)
            ...
            if GetIsUnitActive(self) and not self.attacking and self.attachedToBattery and (self.timeLastAttackEffect + interval < Shared.GetTime())  then
        ...
        if GetIsUnitActive(self) and self.deployed and self.attachedToBattery then
            ...
            if self.attacking then
                ...
                if self.targetDirection then
                    ...
                    swingMult = Sentry.kBarrelMoveTargetMult
