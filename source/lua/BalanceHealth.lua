Log("Loading modified BalanceHealth.lua for NS2 Balance Beta mod.")

-- Changes:
-- Reduced mine HP from 40 to 30 (for a total of 50 eHP once you include armor).
...
kMineHealth = 30    kMineArmor = 5    kMinePointValue = 1
