Log("Loading modified MarineWeaponEffects.lua for NS2 Balance Beta mod.")

-- Changes:
-- Removed the mine beeping sound when deployed, so it can be stopped if mine is destroyed prematurely.
