Log("Loading modified NanoshieldMixin.lua for NS2 Balance Beta mod.")
...
function NanoShieldMixin:GetNanoShieldTimeRemaining()
    ...
    if self.nanoShielded then
        ...
        if self:isa("Player") then
            duration = kNanoShieldDurationPlayers
        else
            duration = kNanoShieldDuration
        end
