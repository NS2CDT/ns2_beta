Log("Loading modified GUIUnitStatus.lua for NS2 Balance Beta mod.")

-- Changes:
-- Add maturity information to the nameplate for some alien structures.
...
function GUIUnitStatus:UpdateUnitStatusBlip2(blipIndex, localPlayerIsCommander, baseResearchRot, showHints, playerTeamType )
    ...
    -- Hints
    showHints = showHints and (not localPlayerIsCommander or isCrosshairTarget)
